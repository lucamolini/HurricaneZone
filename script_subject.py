...
def _export_mail_subject(date_str: str):
    \"\"\"Exports a GitHub Actions output 'subject' for the mail step.\"\"\"
    import os
    subject = f\"Daily HurricaneZone – {date_str}\"
